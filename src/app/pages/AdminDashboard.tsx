          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-8 gap-2">
            {tabs.map((tab) => (
              <button
                ...
                title={tab.label}
                className={`
                  flex min-w-0 items-center justify-center gap-2 px-3 sm:px-4 py-2.5 rounded-lg transition-all
                  ${activeTab === tab.id
              ...
              >
                ...
                <span className="hidden sm:block min-w-0 truncate text-sm">{tab.label}</span>
              </button>
            ))}
          </div>
        </div>
